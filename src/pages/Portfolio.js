        ...
        {netflastinate && (
            <div className="netflastinate" >
                <div className="youtubeContainer">
                    ...
                    <iframe width="780" height="400" src="https://www.youtube.com/embed/il_xlQ79nyk" title="YouTube video player" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
        ...
        {covid && (
            <div className="covid">
                 <div className="youtubeContainer">
                    ...
                    <iframe width="780" height="400" src="https://www.youtube.com/embed/7l0plZNASC4" title="YouTube video player" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
       ...
       {fashun && (
           ...
           className="fashun">
                <div className="youtubeContainer">
                    ...
                    <iframe width="780" height="400" src="https://www.youtube.com/embed/aTrz__8UJ5I" title="YouTube video player" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
        ...
        {calorie && (
            <div className="calorie">
                 <div className="youtubeContainer">
                    ...
                    <iframe width="780" height="400" src="https://www.youtube.com/embed/QSRl5Km5r1o" title="YouTube video player" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
